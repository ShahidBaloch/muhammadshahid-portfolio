...
**Dependency injection (DI)** in ASP.NET Core wires implementations to interfaces at startup so controllers and handlers stay testable. Search intent here is usually **lifetimes**, **Unable to resolve service**, or **why Singleton broke my DbContext** — not “what is IoC?”
